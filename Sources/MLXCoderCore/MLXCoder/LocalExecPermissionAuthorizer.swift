...
public actor LocalExecPermissionAuthorizer {
    ...
    private static func presentMacDialog(
        ...
        on run argv
            ...
            set dialogText to "The `local.exec` tool wants to run a shell command with local access to the workspace." & return & return & "Directory:" & return & workingDirectory & return & return & "Command:" & return & shellCommand & return & return & "If you continue, the command may read or modify files, run scripts, and launch other local processes."
